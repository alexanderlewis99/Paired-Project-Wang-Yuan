...
Based on the results, it seems that the larger the n and the smaller the sigma, the better estimator we get. Overall the change in n and sigma does not change the conclusion of  mle.cover does not cover the true value of $\sigma^2$. But mle_boot.cover and mom_boot.cover both cover the true value. 
A good n value would be around 1000 or larger and a good $\sigma^2$ value would be 0.01
Using 0.001 as $\sigma^2$ and 1,000 as n  we get a bias of almost 0 and an mse of almost 0.
This is the same for $\sigma^2$ =0.001 and n= 10,000.
The mle.boot. always has the shortest length and covers the true value of $\sigma^2$.
